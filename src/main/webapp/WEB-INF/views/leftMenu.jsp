          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
		        ...
		        <li class="nav-item"><a class="nav-link" href="sales_list.jh" class="link-dark rounded white">판매조회</a></li>      
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
		        ...
		        <li class="nav-item"><a class="nav-link" href="${path }/order_list.test" class="link-dark rounded white">주문서</a></li>
		      	<li class="nav-item"><a class="nav-link" href="${path }/purchase_request.test" class="link-dark rounded white">구매요청</a></li>
		      	<li class="nav-item"><a class="nav-link" href="${path }/purchase_status.test" class="link-dark rounded white">구매현황</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
